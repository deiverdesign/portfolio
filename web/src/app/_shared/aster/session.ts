...
// O case existe em duas rotas (/cases/aster em PT, /en/cases/aster em
// EN) que não compartilham nenhum prefixo além da raiz — path do cookie
// precisa ser "/" pra uma sessão desbloqueada valer nas duas, em vez do
// path exato de /cases/aster de antes (só PT). O cookie é HttpOnly e só
// tem sentido nas rotas do ASTER; nas demais páginas ele simplesmente
// nunca é lido, então trafegar nelas não expõe nada.
export const ASTER_SESSION_COOKIE = "aster_session";
export const ASTER_COOKIE_PATH = "/";
